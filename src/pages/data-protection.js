...
const DataProtectionPage = () => (
  <Layout>
    ...
    <Section>
      ...
      <p>
        CV Isabel Winden ("us", "we", or "our") operates the
        https://isabelwinden.netlify.com website (hereinafter referred to as the
        "Service").
      </p>
      ...
      <p>
        ...
        have associated with that data. The Privacy Policy for CV Isabel Winden
      ...
      <p>
        ...
        https://isabelwinden.netlify.com
      </p>
      ...
      <ul>
        <li>
          ...
          <p>
            Service is the https://isabelwinden.netlify.com website operated by
            CV Isabel Winden
          </p>
        </li>
        <li>
      ...
      <p>CV Isabel Winden uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        CV Isabel Winden will take all steps reasonably necessary to ensure that
      ...
      <p>
        CV Isabel Winden may disclose your Personal Data in the good faith
        belief that such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>
          To protect and defend the rights or property of CV Isabel Winden
        </li>
        <li>
      ...
      <ul>
        <li>By email: hans.flicka@gmx.de</li>
      </ul>
    </Section>
  </Layout>
)
